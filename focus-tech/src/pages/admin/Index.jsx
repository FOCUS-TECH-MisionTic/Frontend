            ...
            <div className="relative flex flex-col min-w-0 break-words bg-gray-300 w-full mb-6 shadow-xl rounded-lg -mt-64">
              ...
              <div className="text-center mt-12">
                ...
                <div className="text-sm leading-normal mt-0 mb-2 text-gray-700 font-bold uppercase">
                  <i className="fas fa-user-tag mr-2 text-lg text-gray-700"></i>{userData.rol}
                </div>
                <div className="text-xs leading-normal pt-2 mt-0 mb-2 text-gray-700 font-bold uppercase">
                  
                  <i className="fas fa-info-circle mr-2 text-md text-gray-700"></i>{userData.estado}
                </div>
                <div className="text-xs leading-normal mt-0 mb-2 text-gray-700 font-bold uppercase">
                  <span className="mr-2 text-md text-gray-700">ID:</span>
                  <span className="mr-2 text-md text-gray-700">{userData._id}</span>
                  
                </div>
                <div className="mb-2 text-gray-700 mt-10">
                  <i className="fas fa-at mr-2 text-lg text-gray-700"></i>{user.email}
                </div>
              </div>
            </div>
          </div>
